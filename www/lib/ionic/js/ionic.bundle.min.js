...
!function () {
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.1", function (e) {
        ...
        var s, a = "ios", l = "android", c = "windowsphone", u = n.requestAnimationFrame, d = n.Platform = {navigator: e.navigator, isReady: !1, isFullScreen: !1, platforms: null, grade: null, ua: navigator.userAgent, ready: function (e) {
            ...
            h = 0;
            var t = d.platform(), n = {android: /Android (\d+).(\d+)?/, ios: /OS (\d+)_(\d+)?/, windowsphone: /Windows Phone (\d+).(\d+)?/};
    ...
    var k, Y, H, z, X, F, $, W, U = "touchmove", q = 12, B = 50, Z = {click: i, mousedown: r, mouseup: o, mousemove: s, touchstart: a, touchend: l, touchcancel: u, touchmove: c, pointerdown: a, pointerup: l, pointercancel: u, pointermove: c, MSPointerDown: a, MSPointerUp: l, MSPointerCancel: u, MSPointerMove: c, focusin: p, focusout: m};
    ...
    !function (e) {
        ...
        u.prototype = new l, u.prototype._moveElement = function (t) {
            ...
            this.el.classList.remove(s), this.el.style[e.CSS.TRANSFORM] = "", i.parentNode.insertBefore(this.el, i), i.parentNode.removeChild(i), this.onReorder && this.onReorder(this.el, this._currentDrag.startIndex, r), this._currentDrag = {placeholder: null, content: null}, this._currentDrag = null, n && n()
        ...
        e.views.Slider = e.views.View.inherit({initialize: function (e) {
            ...
            if (p) {
                ...
                var w, y, D = e.auto || 0, L = {}, x = {}, M = {handleEvent: function (n) {
...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            ...
            function h() {
                return C || (C = new e({afterItemsNode: M[0], containerNode: y, heightData: x, widthData: A, forceRefreshImages: !(!f(c.forceRefreshImages) || "false" === c.forceRefreshImages), keyExpression: T, renderBuffer: L, scope: i, scrollView: s.scrollView, transclude: l}))
            }
    ...
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        function c(o) {
            ...
            var s = e.$new(!0);
            u(s, {cancel: g, destructiveButtonClicked: g, buttonClicked: g, $deregisterBackButton: g, buttons: [], cancelOnStateChange: !0}, o || {});
        ...
        function f(e) {
            var t = h(e);
            return D.histories[t.historyId] || (D.histories[t.historyId] = {historyId: t.historyId, parentHistoryId: h(t.scope.$parent).historyId, stack: [], cursor: -1}), d(t.historyId)
        }
        ...
        var $, w, b, y, S = "initialView", k = "newView", C = "moveBack", T = "moveForward", B = "back", I = "forward", x = "enter", A = "exit", E = "swap", V = "none", P = 0, D = {histories: {root: {historyId: "root", parentHistoryId: null, stack: [], cursor: -1}}, views: {}, backView: null, forwardView: null, currentView: null}, L = function () {
        };
        return L.prototype.initialize = function (e) {
            ...
            if ($ !== u && ($ = u, P++), y)M = y.viewId, N = y.action, H = y.direction, y = null; else if (_ && _.stateId === u)M = _.viewId, z = _.historyId, N = C, _.historyId === L.historyId ? H = B : L && (H = A, i = d(_.historyId), i && i.parentHistoryId === L.historyId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))); else if (R && R.stateId === u)M = R.viewId, z = R.historyId, N = T, R.historyId === L.historyId ? H = I : L && (H = A, L.historyId === m.parentHistoryId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))), i = h(e), R.historyId && i.scope && (i.scope.$historyId = R.historyId, z = R.historyId); else if (L && L.historyId !== z && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                ...
                2 > P && (H = V), D.views[M] = this.createView({viewId: M, index: m.stack.length, historyId: m.historyId, backViewId: L && L.viewId ? L.viewId : null, forwardViewId: null, stateId: u, stateName: this.currentStateName(), stateParams: g(), url: O}), m.stack.push(D.views[M])
            }
            if (o.cancel(b), w) {
            ...
            return m.cursor = D.currentView.index, {viewId: M, action: N, direction: H, historyId: z, enableBack: this.enabledBack(D.currentView), isHistoryRoot: 0 === D.currentView.index, ele: l}
    ...
    l.constant("$ionicLoadingConfig", {template: "<ion-spinner></ion-spinner>"}).factory("$ionicLoading", ["$ionicLoadingConfig", "$ionicBody", "$ionicTemplateLoader", "$ionicBackdrop", "$timeout", "$q", "$log", "$compile", "$ionicPlatform", "$rootScope", function (e, t, n, i, o, r, a, c, l, d) {
        ...
        var s = ionic.views.Modal.inherit({initialize: function (e) {
            ...
            i.viewType = i.viewType || "modal", u(o, {$hasHeader: !1, $hasSubheader: !1, $hasFooter: !1, $hasSubfooter: !1, $hasTabs: !1, $hasTabsTop: !1});
    ...
    l.provider("$ionicPlatform", function () {
        ...
        function o(e, o) {
            ...
            f.left < r ? f.left = r : f.left + s + r > u && (f.left = u - s - r), c.top + c.height + l > d && c.top - l > 0 ? (f.top = c.top - l, o.addClass("popover-bottom")) : (f.top = c.top + c.height, o.removeClass("popover-bottom")), h.css({left: c.left + c.width / 2 - h.prop("offsetWidth") / 2 - f.left + "px"}), o.css({top: f.top + "px", left: f.left + "px", marginLeft: "0", opacity: "1"})
        }
    ...
    l.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, c) {
        function s(t) {
            ...
            var o = e.compile({template: I, scope: t.scope && t.scope.$new(), appendTo: r.get()}), c = t.templateUrl ? e.load(t.templateUrl) : n.when(t.template || t.content || "");
            return n.all([o, c]).then(function (e) {
                ...
                return r ? (s.html(r), a(s.contents())(o.scope)) : s.remove(), u(o.scope, {title: t.title, buttons: t.buttons, subTitle: t.subTitle, cssClass: t.cssClass, $buttonTapped: function (e, t) {
                    var n = (e.onTap || g)(t);
        ...
        function m(e) {
            ...
            t.data = {};
            var n = "";
            return e.template && /<[a-z][\s\S]*>/i.test(e.template) === !1 && (n = "<span>" + e.template + "</span>", delete e.template), d(u({template: n + '<input ng-model="data.response" type="' + (e.inputType || "text") + '" placeholder="' + (e.inputPlaceholder || "") + '">', scope: t, buttons: [
                {text: e.cancelText || "Cancel", type: e.cancelType || "button-default", onTap: function () {
                }},
                {text: e.okText || "OK", type: e.okType || "button-positive", onTap: function () {
        ...
        var $ = {stackPushDelay: 75}, w = [], b = {show: d, alert: h, confirm: p, prompt: m, _createPopup: s, _popupStack: w};
        return b
        ...
        function c(n) {
            ...
            return r.then(function (i) {
                ...
                return n.controller && (r = t(n.controller, u(n.locals, {$scope: a})), c.children().data("$ngControllerController", r)), n.appendTo && v(n.appendTo).append(c), e(c)(a), {element: c, scope: a}
            })
        }
        ...
        function s(e, t, n, i) {
            ...
            return n = m || V(t, "view-direction") || r.viewDirection || n || "none", u(l(i), {transition: a, navBarTransition: "view" === s ? a : s, direction: n, shouldAnimate: "none" !== a && "none" !== n})
        }
        ...
        var E, V = ionic.DomUtil.cachedAttr, P = [], D = 1100, L = {create: function (t, d, v, T, E, _) {
            var R, M, N, H = ++A, z = {init: function (e, t) {
                ...
                if (N)ionic.Utils.reconnectScope(R.scope()); else {
                    ...
                    r(R, null, i.direction, !0).run(0), R.data(C, {viewId: i.viewId, historyId: i.historyId, stateName: i.stateName, stateParams: i.stateParams}), (c(d).cache === !1 || "false" === c(d).cache || "false" == R.attr("cache-view") || 0 === o.views.maxCache()) && R.data(w, !0);
                ...
                if (F.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (z.emit("before", O, U), h(R, x), F.run(0)), _ && (C = n.defer(), P.push(C.promise)), E && _)e(p, 16); else {
                    if (!_)return h(R, "entering"), h(M, "leaving"), {run: F.run, cancel: function (t) {
        ...
        B.init = function () {
            ...
            var y = u.data("$ionHeaderBarController"), B = {isActive: o, title: function (e) {
                y.title(e)
            ...
            ionic.DomUtil.cachedAttr(t, "nav-bar-transition", i.navBarTransition), ionic.DomUtil.cachedAttr(t, "nav-bar-direction", i.direction), u.shouldAnimate && i.renderEnd ? p(e, "stage") : (p(e, "entering"), p(n, "leaving")), c.resetBackButton(i), u.run(0), B.activeTransition = {run: function (e) {
        ...
        var r = "translate(32,32)", a = "stroke-opacity", c = "round", s = "indefinite", u = "750ms", d = "none", f = {a: "animate", an: "attributeName", at: "animateTransform", c: "circle", da: "stroke-dasharray", os: "stroke-dashoffset", f: "fill", lc: "stroke-linecap", rc: "repeatCount", sw: "stroke-width", t: "transform", v: "values"}, h = {v: "0,32,32;360,32,32", an: "transform", type: "rotate", rc: s, dur: u}, p = {sw: 4, lc: c, line: [
            ...
            {fn: function (e) {
                return{cx: 32, cy: 32, a: [
                    {fn: function () {
                        return{an: "r", begin: -1 * e + "s", dur: "2s", v: "0;24", keyTimes: "0;1", keySplines: "0.1,0.2,0.3,1", calcMode: "spline", rc: s}
                    }, t: 1},
                    {fn: function () {
        ...
        o.tabs = [], o.selectedIndex = function () {
            ...
            1 === arguments.length && (a = !(!t.navViewName && !t.uiSref)), r && r.$historyId == t.$historyId ? a && n.goToHistoryRoot(t.$historyId) : i !== c && (d(o.tabs, function (e) {
                o.deselect(e)
            }), r = t, i = c, o.$scope && o.$scope.$parent && (o.$scope.$parent.$activeHistoryId = t.$historyId), t.$tabSelected = !0, (t.onSelect || g)(), a && e.$emit("$ionicHistory.change", {type: "tab", tabIndex: c, historyId: t.$historyId, navViewName: t.navViewName, hasNavView: !!t.navViewName, title: t.title, url: t.href, uiSref: t.uiSref}))
        ...
        g.init = function () {
            ...
            if (i && !i.viewNotified) {
                ...
                d.beforeEnter(u(i, {title: v, showBack: !l("hideBackButton"), navBarItems: r, navBarDelegate: h || null, showNavBar: !l("hideNavBar"), hasHeaderBar: !!p})), c()
            }
        ...
        return{restrict: "E", replace: !0, require: "?ngModel", transclude: !0, template: '<label class="item item-checkbox"><div class="checkbox checkbox-input-hidden disable-pointer-events"><input type="checkbox"><i class="checkbox-icon"></i></div><div class="item-content disable-pointer-events" ng-transclude></div></label>', compile: function (t, n) {
            var i = t.find("input");
            d({name: n.name, "ng-value": n.ngValue, "ng-model": n.ngModel, "ng-checked": n.ngChecked, "ng-disabled": n.ngDisabled, "ng-true-value": n.ngTrueValue, "ng-false-value": n.ngFalseValue, "ng-change": n.ngChange}, function (e, t) {
                f(e) && i.attr(t, e)
            });
    ...
    V.forEach(function (e) {
        ...
        return{restrict: "E", require: ["?^$ionicScroll", "ionInfiniteScroll"], template: function (e, t) {
    ...
    l.directive("ionReorderButton", ["$parse", function (e) {
        ...
        return{restrict: "E", replace: !0, require: "?ngModel", transclude: !0, template: '<label class="item item-radio"><input type="radio" name="radio-group"><div class="item-content disable-pointer-events" ng-transclude></div><i class="radio-icon disable-pointer-events icon ion-checkmark"></i></label>', compile: function (e, t) {
            ...
            var n = e.find("input");
            return d({name: t.name, value: t.value, disabled: t.disabled, "ng-value": t.ngValue, "ng-model": t.ngModel, "ng-disabled": t.ngDisabled, "ng-change": t.ngChange}, function (e, t) {
                f(e) && n.attr(t, e)
            }), function (e, t, n) {
                e.getValue = function () {
        ...
        return{restrict: "E", replace: !0, transclude: !0, scope: {autoPlay: "=", doesContinue: "@", slideInterval: "@", showPager: "@", pagerClick: "&", disableScroll: "@", onSlideChanged: "&", activeSlide: "=?"}, controller: ["$scope", "$element", "$attrs", function (t, o, r) {
            var a = t.$eval(t.doesContinue) === !0, c = f(r.autoPlay) ? !!t.autoPlay : !1, s = c ? t.$eval(t.slideInterval) || 4e3 : 0, l = new ionic.views.Slider({el: o[0], auto: s, continuous: a, startSlide: t.activeSlide, slidesChanged: function () {
        ...
        }], template: '<div class="slider"><div class="slider-slides" ng-transclude></div></div>', link: function (e, n, i) {
            function o() {
                if (!r) {
                    var i = e.$new();
        ...
        return{restrict: "E", replace: !0, require: "?ngModel", transclude: !0, template: '<div class="item item-toggle"><div ng-transclude></div><label class="toggle"><input type="checkbox"><div class="track"><div class="handle"></div></div></label></div>', compile: function (e, n) {
            var i = e.find("input");
            return d({name: n.name, "ng-value": n.ngValue, "ng-model": n.ngModel, "ng-checked": n.ngChecked, "ng-disabled": n.ngDisabled, "ng-true-value": n.ngTrueValue, "ng-false-value": n.ngFalseValue, "ng-change": n.ngChange}, function (e, t) {
                f(e) && i.attr(t, e)
